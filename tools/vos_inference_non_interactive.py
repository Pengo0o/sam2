...
def vos_non_interactive_fusion_inference(
    ...
    bwd_mask_last, _ = segment_frame_non_interactive(
        predictor, inference_state, frame_idx=num_frames - 1, score_thresh=score_thresh
    )
    predictor.add_new_mask(inference_state, num_frames - 1, 1, bwd_mask_last)
